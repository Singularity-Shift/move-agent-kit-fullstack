...
export class JouleBorrowTokenTool extends Tool {
  ...
  - "Borrow 10 USDC from position 1234"
  - "Get a loan of 2 WETH from my Joule position"
  - "Borrow 0.1 WBTC from Joule Finance"
  - "Take out a loan of 100 USDt from my Joule lending position"
